...
- **[checklist/personal-ai-security.md](checklist/personal-ai-security.md)** — a one-page checklist covering what an assistant can reach, connectors and permissions, untrusted input, checking anything an assistant hands you before acting on it, and what to do when an agent behaves oddly.

### Notes
- `practitioner-built`.
- The security checklist is the companion to the data-hygiene checklist in the [AI-Era Data & Privacy Playbook](https://github.com/VictorOsondu/ai-data-privacy-playbook) and deliberately doesn't repeat it. Tiers, training and retention toggles, memory settings, redaction, and what never goes into a prompt stay over there.
